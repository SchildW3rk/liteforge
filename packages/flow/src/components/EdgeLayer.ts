...
function injectMarkerDefs(svg: SVGElement): { arrowId: string; arrowClosedId: string } {
  ...
  markerClosed.setAttribute('markerHeight', '10')
  markerClosed.setAttribute('refX', '8')
  markerClosed.setAttribute('refY', '3')
  markerClosed.setAttribute('orient', 'auto')
  markerClosed.setAttribute('markerUnits', 'strokeWidth')
  const polyClosed = document.createElementNS('http://www.w3.org/2000/svg', 'polygon')
  polyClosed.setAttribute('points', '0,0 8,3 0,6')
